    ...
    <div class="space-y-8">
        ...
        <div
            ...
            <div class="hidden md:block z-10">
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10 text-center min-w-40">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-4 bg-rose-50 rounded-2xl border border-rose-100">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <span class="font-bold text-gray-800">{{ $sub->student_name }}</span>
                                <span class="text-xs text-gray-500 block">
                                    {{ $sub->circle_name ?? '-' }} — {{ $sub->unpaid_months_count }} شهر متأخر
                                </span>
                            </div>
                        </div>
