                ...
                <table class="w-full text-right">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-600">
                                @if($subscription->status === 'معفي')
                                {{ $subscription->teacher->name ?? '—' }}
                                @elseif($subscription->collectedBy?->hasRole('admin'))
                                {{ $subscription->teacher->name ?? $subscription->collectedBy->name }}
                                @else
        ...
        function subscriptionFilters() {
            return {
                ...
                init() {
                    ...
                    if (this.selectedCenter || this.selectedCircle || this.selectedTeacher) {
                        this.fetchOptions();
                    }
                },
