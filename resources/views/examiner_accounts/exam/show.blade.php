<x-layouts.markaz-layout>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8"
        ...
        <form method="POST" action="{{ route('examiner.exam.store', $participant) }}" class="space-y-5">
            @csrf
            ...
            {{-- أخطاء الحفظ والتشكيل: تختفي بالكامل لو "لا" --}}
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                @if($previousQuestion)
                <a href="{{ route('examiner.exam.show', $participant) }}?question={{ $previousQuestion->id }}"
