...
submitForm() {
    ...
    // استخدم id مباشرة بدل querySelector المعقد
    ...
    form.submit();
        ...
        // يغير فقط غير المسجلين إلى حاضر
        allPresent() {
        ...
        <form id="attendance-form" action="{{ route('attendance.store') }}" method="POST"
            ...
            <div class="lg:col-span-1 space-y-6 lg:sticky lg:top-6 order-2 lg:order-1">
                ...
                <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100">
                    <h4
                        class="font-black text-gray-800 mb-6 pb-2 border-b border-gray-50 flex items-center gap-2">
                    ...
                    <div class="bg-white rounded-3xl p-5 md:p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-6 transition-all duration-300 group"
                        ...
                        <div class="flex items-center gap-5 flex-1 w-full relative">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-gray-400 text-[10px] tabular-nums"
                                    x-text="`رقم الطالب: #${s.id}`"></p>
                            </div>
                        </div>
        ...
        <div class="bg-white rounded-[3rem] p-24 text-center border border-dashed border-gray-200 shadow-sm">
            ...
            <p class="text-gray-400 font-medium">يمكنك اختيار الحلقة والتاريخ بسرعة من الشريط العلوي لبدء
                التحضير</p>
        </div>
        @endif
    </div>
